    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">تعديل بيانات المورد</h1>
                    <p class="mt-2 text-sm text-gray-600">{{ $supplier->name }} - {{ $supplier->code }}</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="bg-white rounded-lg shadow-sm">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">يتم حسابه تلقائياً من الفواتير والمدفوعات</p>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="notes"
                                      ...
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('notes') border-red-500 @enderror">{{ old('notes', $supplier->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
